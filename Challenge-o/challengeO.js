...
const copied = { 
    ...
    date: new Date(holidays[christmas].date.getTime()) // Copy date properly
};
...
// Check for changes in ID, name, and date
...
const firstMonth =(firstHolidayTime.getMonth() + 1).toString().padStart(2,0);
